...
| -------------------------------- | ----------------------------------------------------------------------------------------- | :------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `children`                       | `JSX.Element \| JSX.Element[]`                                                            |   Yes    | Content to render.                                                                                                                                          |
...
| [`onClick`](handlers/on-click)   | `(event: MouseEvent) => boolean \| void`                                                  |   Yes    | Function to call when mouse click is triggered over the view.                                                                                               |
| [`onWheel`](handlers/on-wheel)   | `(event: MouseEvent) => boolean \| void`                                                  |   Yes    | Function to call when mouse wheel is triggered over the view.                                                                                               |
